...
public class RoundedTextField extends JTextField {
    // Constructor: Configura el texto centrado, fuentes, márgenes internos y fondo transparente
    ...
    // Dibuja el fondo del campo de texto como un rectángulo redondeado con suavizado (anti-aliasing)
    @Override
    ...
    // Dibuja un borde personalizado gris y redondeado alrededor del campo de texto
    @Override
